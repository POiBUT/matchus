/**
 * Модуль валидации данных для проекта matchus
 ...
 */
function checkAlternativeColumns(headers) {
    const alternatives = {
        'lat': 'latitude',
        'latitude': 'latitude',
        'lng': 'longitude',
 ...
 */
function validateCsvStructure(headers, filePath) {
 ...
 */
function validateRecord(record, requiredFields = ['latitude', 'longitude']) {
    const errors = [];
